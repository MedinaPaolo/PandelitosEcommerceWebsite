 ...
 * @author Paolo
 */
public class ProductInformation2 extends javax.swing.JFrame
{

    /**
     * Creates new form ProductInformation2
     */
    public ProductInformation2()
    {
        initComponents();
        setTitle("Product Information");
        ImageIcon icon = new ImageIcon(getClass().getResource("/pandelitosecommercewebsite/Images/SpanishBread.jpg"));
    ...
    private void initComponents()
    {
        ...
        productName.setText("Spanish Bread");

        productDescription.setFont(new java.awt.Font("Serif", 0, 18)); // NOI18N
        productDescription.setText("Fresh and soft bread rolls that are filled with a sweet, buttery paste inside.");
        ...
        productPrice.setText("₱ 8.00 per piece");
    ...
    {//GEN-HEADEREND:event_addToCartActionPerformed
        ...
        String productName = "Spanish Bread";
        double productPrice = 8.00;
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(ProductInformation2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
